namespace HomeXplorer.Controllers
{
    ...
    public class SearchController : BaseController
    {
        ...
        public SearchController(ISearchService searchService, IAgentPropertyService propertyService)
        {
        ...
        private async Task<bool> ValidateDropdownAsync<T>(int dropdownId) where T : class
        {
            ...
            return true; //if dropdown is 0 i won't check it at all - this means the user didn't search by this parameter
        }
    }
}
